...
public partial class LOGMNRC_GTCS
{
    ...
    public decimal? INTERVAL_LEADING_PRECISION { get; set; }

    public decimal? INTERVAL_TRAILING_PRECISION { get; set; }
    ...
    public decimal? EAOWNER_ { get; set; }
    ...
    public decimal? COLLINTCOL_ { get; set; }

    public decimal? ACDRRESCOL_ { get; set; }
}
